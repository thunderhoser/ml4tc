...
def _run(input_prediction_file_name, num_examples_per_subset,
    ...
    print('Writing data to: "{0:s}"...'.format(best_hit_file_name))
    ...
    print('Writing data to: "{0:s}"...'.format(worst_false_alarm_file_name))
    prediction_io.write_file(
    ...
    print('Writing data to: "{0:s}"...'.format(worst_miss_file_name))
    prediction_io.write_file(
    ...
    print('Writing data to: "{0:s}"...'.format(best_correct_null_file_name))
    prediction_io.write_file(
    ...
    print('Writing data to: "{0:s}"...'.format(low_prob_file_name))
    prediction_io.write_file(
    ...
    print('Writing data to: "{0:s}"...'.format(high_prob_file_name))
    prediction_io.write_file(
