...
def plot_colour_map_multi_times(
        example_table_xarray, time_indices, predictor_indices, info_string=None,
        figure_object=None, axes_object=None):
    ...
    # TODO(thunderhoser): Should I really be transposing?
    xt = example_table_xarray
    ...
    pyplot.yticks(
        y_tick_values, y_tick_labels, fontsize=VALID_TIME_FONT_SIZE
    )
...
def plot_pm_signs_multi_times(
    ...
    :param data_matrix: V-by-T numpy array of data values to plot.
    :param axes_object: Will plot on these axes (instance of
