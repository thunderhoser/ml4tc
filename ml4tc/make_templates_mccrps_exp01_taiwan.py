"""Makes CNN templates for MC/CRPS Experiment 1 for Taiwan problem."""
...
BASE_OPTION_DICT_GRIDDED_SAT = {
    ...
    cnn_architecture.DROPOUT_MC_FLAGS_KEY: numpy.full(12, 1, dtype=bool),
...
BASE_OPTION_DICT_SHIPS = {
    ...
    cnn_architecture.DROPOUT_MC_FLAGS_KEY: numpy.full(2, 1, dtype=bool),
...
BASE_OPTION_DICT_DENSE = {
    ...
    cnn_architecture.DROPOUT_MC_FLAGS_KEY: numpy.full(5, 1, dtype=bool),
    cnn_architecture.INNER_ACTIV_FUNCTION_KEY:
        architecture_utils.RELU_FUNCTION_STRING,
    cnn_architecture.INNER_ACTIV_FUNCTION_ALPHA_KEY: 0.2,
    cnn_architecture.OUTPUT_ACTIV_FUNCTION_KEY:
...
OUTPUT_DIR_NAME = (
    ...
    'mccrps_experiment01_td-to-ts/templates'
)
    ...
    for i in range(len(SECOND_LAST_LAYER_DROPOUT_RATES)):
        for j in range(len(THIRD_LAST_LAYER_DROPOUT_RATES)):
            for k in range(len(FOURTH_LAST_LAYER_DROPOUT_RATES)):
                ...
                model_object = cnn_architecture.create_crps_model_td_to_ts(
