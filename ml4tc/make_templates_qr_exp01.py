"""Makes CNN templates for Quantile-regression Experiment 1."""
...
BASE_OPTION_DICT_SHIPS = {
    cnn_architecture.INPUT_DIMENSIONS_KEY: numpy.array([5, 75], dtype=int),
...
OUTPUT_DIR_NAME = (
    '/scratch1/RDARCH/rda-ghpcs/Ryan.Lagerquist/ml4tc_models/qr_experiment01/'
    'templates'
)
