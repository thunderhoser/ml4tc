"""Makes CNN templates for CRPS Experiment 2-SZA for RI problem.

'SZA' means that solar zenith angle is always included in the forecast SHIPS
predictors.
"""
