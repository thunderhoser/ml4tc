"""Makes CNN templates for Experiment 12 with rotated images and no L_2."""
...
OUTPUT_DIR_NAME = (
    ...
    'experiment12_rotated_no-l2/templates'
)


def _run():
    """Makes CNN templates for Experiment 12 with rotated images.
